...
class InferenceGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        palette.setColor(QPalette.Window, QColor(90, 106, 130))  # Deep blue-grey color
        ...
        self.input_image_title.setStyleSheet("color: white; font-size: 20px; font-weight: bold;")
        ...
        self.output_image_title.setStyleSheet("color: white; font-size: 20px; font-weight: bold;")
        ...
        button_style = "border-radius: 10px; padding: 10px 20px;"
