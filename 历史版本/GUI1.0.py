...
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QFileDialog, QLabel, QTextEdit
...
class InferenceGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        left_layout.addWidget(self.image_label, 3)
        ...
        right_layout.addLayout(model_buttons_layout)
        ...
        right_layout.addLayout(input_output_layout)
    ...
    def select_output_folder(self):
        ...
        if self.output_folder:
            self.log(f"Output folder selected: {self.output_folder}")
    ...
    def run_inference(self):
        ...
        # 显示颜色映射后的图像
        self.display_image(colored_output_path)
