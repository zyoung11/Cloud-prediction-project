document.addEventListener('DOMContentLoaded', function() {    
    ...
    const altLabels = ['10min', '30min', '1h', '2h', '3h',     '10min', '30min', '1h', '2h', '3h',        '10min', '30min', '1h', '2h', '3h',     '10min', '30min', '1h', '2h', '3h',   '10min', '30min', '1h', '2h', '3h'];   
    ...
    function displayResults() {    
        ...
        const specificDates = specificIndices.map(index => uploadedFiles[index - 1]); 
        let groupIndex = 0; 
        let dateContainers = []; 
